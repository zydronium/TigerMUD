...
{
	/// <summary>
	/// Parent class that all commands must inherit from.
	/// </summary>
	public class Command : ICommand
	{
		protected string name = "";
		protected string[] words = {};
		protected HelpInfo help = new HelpInfo();
		
		public Command()
		{
		}
		
		public virtual bool DoCommand(Actor actor, string command, string arguments)
		{
