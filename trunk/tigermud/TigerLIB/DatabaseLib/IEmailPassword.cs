...
namespace TigerMUD.DatabaseLib
{
    ...
    ///// <returns>A DataTable containing the user's password and email address.</returns>
    //DataTable GetUserInfo(string shortName);

    ///// <summary>
    ///// Update user's password with newly generated password.
    ///// </summary>
    ///// <param name="shortName">The user's short name.</param>
    ///// <param name="emailAddress">The new email address.</param>
    //void UpdateUserPassword(string shortName, string password);
