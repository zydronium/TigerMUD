...
namespace TigerMUD.DatabaseLib
{
	...
	{
    /// <summary>
    /// Get a complete list of all commands in the
    /// database for a given access level.
    /// </summary>
    /// <param name="accessLevel">The access level.</param>
    /// <returns>A table of commands.</returns>
    DataTable GetAllCommands(int accessLevel);
	}
}
