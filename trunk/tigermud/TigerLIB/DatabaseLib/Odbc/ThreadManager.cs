...
{
	/// <summary>
	/// An ODBC implementation of IThreadManager.
	/// </summary>
	public class ThreadManager : BaseOdbc, IThreadManager
	{
		public ThreadManager(string connectionString) : base (connectionString)
		{
		}

    public DataTable GetAllCommands(int accessLevel)
    {
      string statement = "SELECT commandname FROM mudcommands WHERE type=" + accessLevel + " AND actorid='0';";
