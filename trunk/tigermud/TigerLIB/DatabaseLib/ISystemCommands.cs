...
{
  /// <summary>
  /// Handles all SystemCommands data operations.
  /// </summary>
  public interface ISystemCommands
  {
    ...
    /// </summary>
    /// <param name="accessLevel">The command access level</param>
    /// <param name="command">The command.</param>
    void AddCommand(int accessLevel, string command);
    ...
    /// <param name="accessLevel">The command access level</param>
    /// <param name="command">The command.</param>
    void AddCommandToDb(int accessLevel, string command);
    ...
    /// <summary>
    /// Get the access level of a system command.
    /// </summary>
    /// <param name="command">The name of the command.</param>
    /// <returns>The associated access level.</returns>
    int GetCommandAccessLevel(string command);
  }
}